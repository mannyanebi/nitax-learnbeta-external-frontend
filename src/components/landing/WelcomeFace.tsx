...
export default function WelcomeFace() {
  return (
    <BackgroundImage src={doodleBg.src} className='pt-8 bg-no-repeat w-full max-w-[65rem] xl:max-w-[80rem] 2xl:max-w-[85rem] mx-auto px-4 sm:px-8 md:px-10 bg-cover bg-center'>
