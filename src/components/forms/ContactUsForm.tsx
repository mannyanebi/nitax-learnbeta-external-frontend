...
const ContactUsForm: React.FC<Props> = ({ form, mutation, handleSubmit }) => {
  return (
    <Form
    ...
    >
        ...
        <Input
          ...
          className={`w-full border-black placeholder:text-black ${
            form.errors.email
              ...
              : "focus: !outline-[#00433F]"
          } border-2 px-3 py-5 rounded-sm transition duration-75 delay-75 ease-linear placeholder:text-sm`}
        />
      </Box>
      ...
      <Box>
        <TextArea
          ...
          className={`w-full border-black placeholder:text-black min-h-[10rem] max-h-[15rem] ${
            form.errors.message
              ? "focus:!outline-red-500"
              : "focus:!outline-[#00433F]"
          } border-2 px-3 py-5 rounded-sm transition duration-75 delay-75 ease-linear placeholder:text-sm`}
