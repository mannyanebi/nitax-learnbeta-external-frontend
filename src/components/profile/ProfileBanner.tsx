  ...
  return (
    <Box className="mx-4 sm:mx-6 lg:px-8">
      <Box className="hidden lg:block">
        <BackgroundImage className="rounded-xl px-16 h-32 xl:px-28 max-w-[75rem] mx-auto" src={yellowBg.src}>
        </BackgroundImage>

        <Box className="w-full max-w-[65rem] px-16 xl:px-0 mt-[-5.2rem] mx-auto">
