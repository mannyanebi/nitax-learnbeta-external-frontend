...
const GradeCheckCard = ({ gradeLevel, grade, mutation }: GradeCheckCardProps) => {
  return (
    <Box className={`border-2 transition duration-75 delay-75 ease-linear ${grade === gradeLevel.id.toString() ? 'border-[#FAA61A]' : 'border-[#E2E2E2]'} hover:border-[#FAA61A] p-4`}>
      <Radio
